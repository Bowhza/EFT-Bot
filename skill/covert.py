...
def game():
    while True:
        if pyautogui.locateOnScreen('images/launcher.png', grayscale=True, confidence=0.8) != None:
            ...
            logging.info("False exit, returning to main menu game")
            time.sleep(0.5)

        elif pyautogui.locateOnScreen('images/eftmenu.png', grayscale=True, confidence=0.5) != None:
            pydirectinput.click(971, 646)
            logging.info("In main menu")
            time.sleep(0.5)

        elif pyautogui.locateOnScreen('images/eftmenuhighlight.png', grayscale=True, confidence=0.5) != None:
            pydirectinput.click(971, 646)
            logging.info("In main menu")
            time.sleep(0.5)

        elif pyautogui.locateOnScreen('images/pmc.png', grayscale=False, confidence=0.5) != None:
        ...
        elif pyautogui.locateOnScreen('images/pmc2.png', grayscale=False, confidence=0.5) != None:
            pydirectinput.click(1202, 694)
            logging.info("Entering map selection")
            time.sleep(0.5)
            pydirectinput.click(958, 946)
